# -*- coding: utf-8 -*-
"""LSTMsGlobal_Analysis_and_Predictions_.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1HbOTk6iKd9UrbEpI5IWIwggJY3w7rlZm
...
def cudnn_gru_model():
    ...
    model.add(GRU(128,input_shape=(X_train_death.shape[1], X_train_death.shape[2]),return_sequences = True))
...
model.fit(X_train_death, y_train_death, batch_size = 16, epochs = 500, verbose = 0)
